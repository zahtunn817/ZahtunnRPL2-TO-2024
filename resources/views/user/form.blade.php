            ...
            <div class="modal-body">
                <form method="post" action="user">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control col-sm-8" id="nama" name="nama" placeholder="Nama user">
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="file" class="form-control col-sm-8" id="image" name="image" placeholder="Foto">
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="email" class="form-control col-sm-8" id="email" name="email" placeholder="Email">
                    </div>
                    <div class="form-group row">
