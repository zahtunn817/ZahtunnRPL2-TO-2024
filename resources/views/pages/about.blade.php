            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <ul>
                        ...
                        <li><b>Stok</b> dimana admin dapat memasukkan atau mengubah stok menu.</li>
                        <li><b>Kelola data</b> dimana admin dapat mengelola data seperti menu, data petugas, dan data pelanggan.</li>
                        <li><b>Laporan</b> dimana admin dapat mengelola laporan untuk disampaikan kepada atasan atau <i>owner</i>.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <h5>Mengapa SE2?</h5>
                    <p>
                        Dinamakan seperti itu karena pembuat aplikasi ini berasal dari kelas RPL (Rekayasa Perangkat Lunak) 2 atau <i>Software engineering</i> 2 yang disingkat menjadi SE2.
                    </p>
                </div>
            </div>
        </div>
